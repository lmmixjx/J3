...
public class J3App {
    ...
    private static final Logger log = LoggerFactory.getLogger(J3App.class);

    private final Environment env;

    public J3App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(J3App.class);
